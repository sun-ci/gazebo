...
const COPY_APP_INSTALL_STRING = `Hello, could you help approve the installation of the Codecov app on GitHub for our organization? Here's the link: https://github.com/apps/${config.GH_APP}/installations/select_target`
